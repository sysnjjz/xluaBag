    ...
    public class LuaBridgeWrap 
    {
        ...
        static int _m_SaveLocalItemJson_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.List<LuaLocalItem> _localItemData = (System.Collections.Generic.List<LuaLocalItem>)translator.GetObject(L, 1, typeof(System.Collections.Generic.List<LuaLocalItem>));
                    
                    LuaBridge.SaveLocalItemJson( _localItemData );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SaveDeployHeroJson_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.Dictionary<int, LuaLocalItem> _deployHeroData = (System.Collections.Generic.Dictionary<int, LuaLocalItem>)translator.GetObject(L, 1, typeof(System.Collections.Generic.Dictionary<int, LuaLocalItem>));
                    
                    LuaBridge.SaveDeployHeroJson( _deployHeroData );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetHeroList_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = LuaBridge.GetHeroList(  );
                        translator.Push(L, gen_ret);
